# Instagram Content Quality MVP v0.9.15

投稿タイプ別の生成・表示と、日本国内での公式採用情報を確認できる企業への限定を追加しました。
...
- キャプションのワンクリックコピー
- 5種類の「2分で分かる」調査レポート
- 投稿タイプIDを生成原稿へ保持し、表紙・各ページ見出し・内容構成の取り違えを防止
- 日本法人・日本拠点の公式採用ページ・日本勤務求人のいずれかを検索確認できる企業だけを掲載
